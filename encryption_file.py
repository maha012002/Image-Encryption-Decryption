...
with open("./test_files/tryout.jpg","rb") as file:
    plaintext = file.read()


print("Length of Ciphertext: "+str(len(plaintext)))
print("Input image graph")
input_image = Image.open("./test_files/tryout.jpg")
...
output_image.save("./test_files/encrypt32.png")
print("The image has been encrypted successfully!")

# Display the histogram of the output image
output_image = Image.open("./test_files/encrypt32.png")
